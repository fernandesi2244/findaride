    ...
    <div class="row">
      <div class="col-2">
        ...
        <button
          ...
          <button
            class="nav-link text-start"
            id="v-pills-triprequests-tab"
            data-bs-toggle="pill"
            data-bs-target="#v-pills-triprequests"
            type="button"
            role="tab"
            aria-controls="v-pills-triprequests"
            aria-selected="false"
          >
      ...
      <div class="col-10 tab-content px-4" id="v-pills-tabContent">
          ...
          <div
          class="tab-pane fade"
          id="v-pills-triprequests"
          role="tabpanel"
          aria-labelledby="v-pills-triprequests-tab"
          >
