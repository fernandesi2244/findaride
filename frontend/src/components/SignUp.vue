...
<script setup>
  ...
  async function submitSignUp() {
    ...
    try {
      ...
      router.push('/login'); // Redirect to login after successful registration, as in prod we want the user to verify their email before logging in. If user already exists, redirect to login page.
    } catch (error) {
      console.log(error);
    }
  }
